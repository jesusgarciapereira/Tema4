...
public class Ejercicio02 {
	...
	public static void main(String[] args) {
		...
		// Enseñamos la tabla de las notas de los alumnos
		...
		for (int i = 0; i < cantAlumnos; i++) {
			// En cada iteración del bucle, inicializamos las variables
			notaMin = -1;
			notaMax = -1;
			sumaNotas = 0;
			notaMedia = -1;
